...
export function createBoxColliders(): ColliderDefinition[] {
  ...
  const definitions = [
    {
      size: new THREE.Vector3(1, 2, 15),
      position: new THREE.Vector3(5, -0.5, 1),
      rotation: new THREE.Euler(0, Math.sin(Math.PI / 5), 0),
      color: 0xff0000,
    },
    {
      size: new THREE.Vector3(15, 2, 1),
      position: new THREE.Vector3(0, -0.5, -3.5),
      rotation: new THREE.Euler(0, Math.sin(7*Math.PI / 8), 0),
      color: 0x00ff00,
    },
    {
      size: new THREE.Vector3(1, 2, 15),
      position: new THREE.Vector3(-4.5, -0.5, 1),
      rotation: new THREE.Euler(0, Math.sin(Math.PI / 7), 0),
      color: 0x0000ff,
    },
    {
      size: new THREE.Vector3(15, 2, 1),
      position: new THREE.Vector3(0, -0.5, 2.3),
      rotation: new THREE.Euler(0, Math.sin(7*Math.PI / 8), 0),
      color: 0x00ffff,
    },
