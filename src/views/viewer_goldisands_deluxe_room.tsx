...
import { createBoxColliders } from "./goldisands_deluxe_room_colliders";
import * as CANNON from "cannon-es";

function ViewerGoldisandsDeluxeRoom() {
  ...
  useEffect(() => {
    ...
    // Step 2: Scene load
    viewer
      .addSplatScene("/splats/goldisands_deluxe_room.ksplat", {
...
export default ViewerGoldisandsDeluxeRoom;
